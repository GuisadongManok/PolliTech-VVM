...
"}"));
        ...
        gridLayout_7->addWidget(line_3, 3, 0, 1, 2);
...
""));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 434, 261));
...
"}"));
        ...
        gridLayout_7->addLayout(gridLayout_skchair, 1, 1, 1, 1);
...
"}"));
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, 0, 434, 260));
...
"}"));
        ...
        gridLayout_7->addLayout(gridLayout_skcouncilors, 2, 1, 1, 1);
...
""));
        ...
        gridLayout_7->addWidget(submitButton, 4, 0, 1, 2, Qt::AlignmentFlag::AlignHCenter|Qt::AlignmentFlag::AlignVCenter);
...
"}"));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 434, 260));
...
"}"));
        ...
        gridLayout_7->addLayout(gridLayout_councilors, 2, 0, 1, 1);
...
""));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 434, 261));
...
"}"));
        ...
        gridLayout_7->addLayout(gridLayoutcap, 1, 0, 1, 1);
